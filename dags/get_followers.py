...
http_task = SimpleHttpOperator(
    ...
    data={'accounts': ['Booksybiz', 'Wahlpro', 'Titanbarber', 'Official cuts', 'Unitedbyshorthair', 'Behindthechair', 'Ruelrockstar', 'Underratedbarbers', 'Humblythegreatest', 'Arodpr23', 'Phillipwolf'], 'followers': 1},  # Add any data if needed
